...
def test_next_multiple_of_n_additional():
    ...
    assert train_gpt.next_multiple_of_n(0.1, n=5) == 5
    assert train_gpt.next_multiple_of_n(128, n=128) == 128
    assert train_gpt.next_multiple_of_n(128.1, n=128) == 256
    assert train_gpt.next_multiple_of_n(-0.1, n=5) == 0
